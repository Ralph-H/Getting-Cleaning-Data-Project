...
The program then tidies and merges the data, downselects to the appropriate variables containing meand and standard deviation measurements, and performs the analysis as described in detail in the codebook.
